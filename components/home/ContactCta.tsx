...
export async function ContactCta({ locale }: { locale: AppLocale }) {
  ...
  return (
    <section className="py-20">
      <Container className="max-w-2xl text-center">
        <Reveal>
          <h2 className="text-2xl font-semibold tracking-tight text-fg sm:text-3xl">{t("title")}</h2>
          <p className="mt-3 text-base leading-relaxed text-fg-muted">{t("body")}</p>
